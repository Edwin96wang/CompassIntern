void test(){
    TFile *file = new TFile("/localhome/ywang/analysis_compass/hist/hist69666.root", "READ");
    TH1D* ThreePion_inv_mass = nullptr;
    gErrorIgnoreLevel = kWarning;
    file->GetObject("ThreePion_inv_mass", ThreePion_inv_mass);
    int bin_left = ThreePion_inv_mass->FindFirstBinAbove(ThreePion_inv_mass->GetMaximum()*0/10);
