void test(){
    TFile *file = new TFile("./hist/hist69853.root", "READ");
    ...
    int bin_right = ThreePion_inv_mass->FindLastBinAbove(ThreePion_inv_mass->GetMaximum()*5.7/10);
    double pos_left = ThreePion_inv_mass->GetBinCenter(bin_left);
    double pos_right = ThreePion_inv_mass->GetBinCenter(bin_right);
    TF1* f = new TF1("fit function", "[0]*TMath::Gaus(x,[1],[2])", pos_left, pos_right);
    cout << pos_left << endl;
    cout << pos_right << endl;
