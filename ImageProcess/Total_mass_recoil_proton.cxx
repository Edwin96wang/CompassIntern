...
void Total_mass_recoil_proton(){
    ...
    file->GetObject("recProton_width", g2);
    ...
    legend->AddEntry(new_g2, "width from recoil proton");
    legend->Draw();
